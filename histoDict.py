...
def SampleDict():
    dict = {
        ...
        'yy+jetscc':
        {
            'histoname': 'yy+jetscc',
            'color': (0, 114, 178),
            'legend description': '#it{#gamma#gamma+cc}',
        ...
        'yy+jetscl':
        {
            'histoname': 'yy+jetscl',
            'color': (204, 121, 167),
            'legend description': '#it{#gamma#gamma+cl}',
        ...
        'yy+jetsll':
        {
            'histoname': 'yy+jetsll',
            'color': (136, 136, 136),
            'legend description': '#it{#gamma#gamma+ll}',
...
def SelectionDict():
    dict = {
        'Run2_preselection': {
            ...
            'legend lower': '',
            'sfs': { "yy+jetsbb": 1.7906, "yy+jetsbj": 1.7906, "yy+jetscc": 1.7906, "yy+jetscl": 1.7906, "yy+jetsll": 1.7906,
        ...
        'Run3_preselection': {
            ...
            'legend lower': '',
            'sfs': { "yy+jetsbb": 1.4681, "yy+jetsbj": 1.4681, "yy+jetscc": 1.4681, "yy+jetscl": 1.4681, "yy+jetsll": 1.4681,
        ...
        'Run2_preselection_sidebands': {
            ...
            'sfs': { "yy+jetsbb": 1., "yy+jetsbj": 1., "yy+jetscc": 1., "yy+jetscl": 1., "yy+jetsll": 1.,
