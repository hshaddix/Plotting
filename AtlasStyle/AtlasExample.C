...
{ 
  ...
  Int_t icol1=myColor(0);
  Int_t icol2=myColor(1);
  ...
  for (Int_t icut=0; icut<ncut; icut++) { // loop over cuts
	...
	return; 
      ...
      g1[ir][icut]->SetLineColor(kBlack);
    ...
    data[icut]->SetMarkerColor(kBlack);
