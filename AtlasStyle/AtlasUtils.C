// Implementation of helper functions in ATLAS Utils
...
int myColor(int sequence_number=0){
  static const std::vector<std::string> color_sequence({"#3f90da","#ffa90e","#bd1f01","#94a4a2","#832db6","#a96b59","#e76300","#b9ac70","#717581","#92dadd"});
  return TColor::GetColor( color_sequence[ sequence_number%10 ].c_str() );
}
